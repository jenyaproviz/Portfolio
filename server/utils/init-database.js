...
const initializeDatabase = async () => {
  try {
    // Create three users only if they don't exist
    ...
    // Only seed demo posts/comments if there are no posts
    ...
    if (postCount === 0) {
      ...
      const post3 = await Post.create({
        ...
        imgUrl:
          "france-in-pictures-beautiful-places-to-photograph-st-tropez-street.jpg",
        author: admin,
      });
